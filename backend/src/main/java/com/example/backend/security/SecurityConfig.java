...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // Mở CORS bằng cấu hình bên dưới
    ...
    // Cấu hình cho phép Frontend ở localhost gọi API mà không bị chặn
    @Bean
