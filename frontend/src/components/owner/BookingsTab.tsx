...
const BookingsTab = ({ bookings, pitches, isLoadingBookings, handleNoShow, handleCheckOut }: BookingsTabProps) => {
              ...
              <div className="flex flex-col items-end w-full md:w-auto mt-4 md:mt-0">
                ...
                {bk.status === 'DEPOSIT_PAID' && (
                  <div className="flex flex-col gap-2 w-full md:w-auto">
                    ...
                    <Button variant="danger" className="w-full px-4 py-2 flex items-center justify-center gap-2 text-sm" onClick={() => handleNoShow(bookingIdToDisplay)}>
                      <FaTimes /> Bùng Kèo
                    </Button>
                  </div>
                )}
