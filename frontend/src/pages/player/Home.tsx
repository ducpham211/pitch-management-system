		...
		<div className="flex flex-col gap-10">
			<div className="bg-white p-10 rounded-2xl shadow-sm text-center border border-gray-100">
				...
				<p className="text-gray-600 mb-8 text-lg max-w-2xl mx-auto">
					Nền tảng giúp bạn tìm kiếm sân bóng gần nhất, đặt lịch nhanh chóng, cọc giữ chỗ
					an toàn và kết nối giao hữu với hàng ngàn đội bóng khác.
				</p>
				<Link to="/tim-san">
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				...
				<div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition">
					...
					<p className="text-gray-600 leading-relaxed">
						Hỗ trợ cọc tiền sân qua các cổng thanh toán online, đảm bảo giữ chỗ minh
						bạch.
					</p>
				</div>
			</div>
